...
## 🚀 **Welcome to the Data Officer's Console!**
...
* Select **Download ZIP**.
**Important:** Extract (unzip) the downloaded folder to a location on your computer (e.g., `Documents/MarsMission`). Do not try to run files directly inside the ZIP archive.
...
**Steps:**
1. Open VS Code.
2. Go to **File > Open Folder...** and select the folder you downloaded.
3. Open any file ending in **.ipynb** (Lessons 0-3).
4. Select your Kernel (Python environment) in the top-right corner.
5. For Lesson 4 (Streamlit), you will run the `.py` files using the integrated terminal (`streamlit run app.py`).
...
4. Click on the notebook you want to open.
